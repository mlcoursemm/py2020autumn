...
| 10            | 11.12.2020    | [Дополнительные главы: параллельное программирование, http-запросы](lectures/Python10-Parallel.ipynb) |                  | Петюшко А. А. |
...
# Python programming language in machine learning tasks
...
* Well, you can always write in [issues](https://github.com/mlcoursemm/py2020autumn/issues) :)
## <a name="marks1" /> Task results
* [Summary table with results](https://docs.google.com/spreadsheets/d/1qouDyNQo6IeNy2S9PxorO3U9MFoBDlwhPNBSljamZXY/edit?usp=sharing)
